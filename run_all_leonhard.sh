...
run_in_python2_env ./src/conversion/train.py --model_dir='./model/conversion/pretrained' --model_name='pretrained'
run_in_python2_env ./src/conversion/convert.py --model_dir='./model/conversion/pretrained' --model_name='pretrained' 
