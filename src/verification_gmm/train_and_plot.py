...
if __name__ == '__main__':
    ...
    for case in ['disjoint','shared']:
        ...
        pickle.dump(one_clip_scores, 
                    open( os.path.join(score_dir, 'one_clip_scores_({}_data_for_VC_and_Verif).p'.format(case)), "wb" ), 
                    protocol=pickle.HIGHEST_PROTOCOL)
        pickle.dump(scores, 
                    open( os.path.join(score_dir, 'scores_({}_data_for_VC_and_Verif).p'.format(case)), "wb" ), 
                    protocol=pickle.HIGHEST_PROTOCOL)
        pickle.dump(score_means, 
                    open( os.path.join(score_dir, 'score_means_({}_data_for_VC_and_Verif).p').format(case), "wb" ), 
                    protocol=pickle.HIGHEST_PROTOCOL)
