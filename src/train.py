        ...
        if validation_A_dir is not None:
            if epoch % 100 == 0:
                ...
                for file in os.listdir(validation_A_dir):
                    ...
                    librosa.output.write_wav(os.path.join(validation_A_output_dir+"_{}epc".format(epoch), os.path.basename(file)), wav_transformed, sampling_rate)
        ...
        if validation_B_dir is not None:
            if epoch % 100 == 0:
                ...
                for file in os.listdir(validation_B_dir):
                    ...
                    librosa.output.write_wav(os.path.join(validation_B_output_dir+"_{}epc".format(epoch), os.path.basename(file)), wav_transformed, sampling_rate)

if __name__ == '__main__':

    parser = argparse.ArgumentParser(description = 'Train CycleGAN model for datasets.')

    train_A_dir_default = './data/vcc2016_training/OB'
    train_B_dir_default = './data/vcc2016_training/TM1'
    model_dir_default = './model/ob_tm1'
    model_name_default = 'ob_tm1.ckpt'
    random_seed_default = 0
    validation_A_dir_default = './data/evaluation_all/OB'
